...
function DataGridSearchImpl({
  ...
  const onTriggerPointerDown = React.useCallback((event) => {
  ...
  const onPrevMatchPointerDown = React.useCallback((event) =>
    onTriggerPointerDown(event), [onTriggerPointerDown]);

  const onNextMatchPointerDown = React.useCallback((event) =>
    onTriggerPointerDown(event), [onTriggerPointerDown]);
  ...
  return (
    <div
      ...
      <div
        className="flex items-center gap-1 whitespace-nowrap text-muted-foreground text-xs">
