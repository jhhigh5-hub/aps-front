...
export function DataGrid(
  ...
  const onRowAdd = React.useCallback((event) => {
  ...
  const onFooterCellKeyDown = React.useCallback((event) => {
          ...
          <div
            ...
            <div
              ...
              <div
                ...
                <div
                  className="sticky start-0 flex items-center gap-2 px-3 text-muted-foreground">
